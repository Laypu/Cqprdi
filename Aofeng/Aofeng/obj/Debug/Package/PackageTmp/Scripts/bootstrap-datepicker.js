...
(function ($, undefined) {
    ...
    Datepicker.prototype = {
        ...
        formatYearHead: function (year, month) {
      
            if (month != null) {
                if (this.o.format === "twy/mm/dd")
        ...
        fill: function () {
            ...
            this.picker.find('.datepicker-days thead th.datepicker-switch')
                .text(this.formatYearHead(year, month));
            this.picker.find('tfoot th.today')
                .text(todaytxt)
            ...
            var yearCont = this.picker.find('.datepicker-years')
                .find('th:eq(1)')
                .text(this.formatYearHead(year) + '-' + this.formatYearHead(year + 9))
                .end()
                .find('td');
            year -= 1;
            ...
            for (var i = -1; i < 11; i++) {
                ...
                html += '<span class="' + classes.join(' ') + '">' + this.formatYear(year) + '</span>';
                year += 1;
            }
            yearCont.html(html);
        },
    ...
    var DPGlobal = {
        ...
        parseDate: function (date, format, language) {
            ...
            date = new Date();
            var parsed = {},
                setters_order = ['yyyy', 'yy', 'M', 'MM', 'm', 'mm', 'd', 'dd', 'twy'],
                setters_map = {
                    yyyy: function (d, v) {
                    ...
                    twy: function (d, v) {
                        return d.setUTCFullYear(1911 + v);
                    }
                },
                val, filtered;
